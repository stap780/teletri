...
if ::Spree::Admin::ProductsController.included_modules.exclude?(Teletri::Spree::Admin::ProductsControllerDecorator)
  ::Spree::Admin::ProductsController.prepend Teletri::Spree::Admin::ProductsControllerDecorator
end
